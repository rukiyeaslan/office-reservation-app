...
import { AuthAdminSchema, createUserSchema, forgotPasswordSchema, resetPasswordSchema, verifyUserSchema } from "../schemas/User";
...
router.get('/me',validateResource(AuthAdminSchema), getCurrentUserHandler);
export = router;